...
public class InfraController {
	...
	public String criaBanco() throws SQLException {
		...
		PreparedStatement st1 = c.prepareStatement("drop table produto if exists");
		st1.execute();

		PreparedStatement st11 = c.prepareStatement("create table produto (id int identity, descricao varchar(255), valor double, quantidade int, dataEntrada datetime)");
		st11.execute();
		...
		PreparedStatement st3 = c.prepareStatement("insert into usuarios (login, senha) values ('eric', '123');");
		st3.execute();
