...
import br.com.treinamento.estoque.modelo.TipoDoProduto;
...
public class ProdutoDAO {
	...
	public void adiciona(Produto conta) {
	...
	public void remove(Produto conta) {
	...
	public void altera(Produto conta) {
	...
	public List<Produto> lista() {
		try {
			List<Produto> contas = new ArrayList<Produto>();
	...
	private Produto populaConta(ResultSet rs) throws SQLException {
		Produto conta = new Produto();
		...
		conta.setTipo(Enum.valueOf(TipoDoProduto.class, rs.getString("tipo")));
